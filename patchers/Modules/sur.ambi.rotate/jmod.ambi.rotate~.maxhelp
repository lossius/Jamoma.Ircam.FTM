{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 200.0, 60.0, 1092.0, 785.0 ],
		"bglocked" : 0,
		"defrect" : [ 200.0, 60.0, 1092.0, 785.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"id" : "obj-4",
					"maxclass" : "bpatcher",
					"name" : "jmod.ambi.rotate~.maxpat",
					"numinlets" : 2,
					"numoutlets" : 2,
					"outlettype" : [ "", "audio.connect" ],
					"patching_rect" : [ 290.0, 360.0, 300.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 25.0, 735.0, 175.0, 29.0 ],
					"text" : "/source.3/position 0.69282 0.4 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 290.0, 525.0, 116.0, 17.0 ],
					"text" : "/head KEMAR"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 25.0, 680.0, 154.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 25.0, 210.0, 109.0, 41.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 25.0, 270.0, 200.0, 400.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "audio.connect" ],
					"patching_rect" : [ 290.0, 170.0, 300.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "signal", "signal" ],
					"patching_rect" : [ 290.0, 445.0, 300.0, 70.0 ],
					"presentation_rect" : [ 0.0, 0.0, 300.0, 70.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "@name", "jmod.ambi.rotate~", "@description", "Rotate 1st order (B-format) ambisonic signal." ],
					"bgmode" : 1,
					"id" : "obj-1",
					"maxclass" : "bpatcher",
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 0.0, 1092.0, 70.0 ],
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 34.5, 717.0, 261.0, 717.0, 261.0, 263.0, 299.5, 263.0 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 34.5, 732.0, 190.5, 732.0 ],
					"source" : [ "obj-12", 0 ]
				}
